...
export const axiosShowShoppingCartItems = (data) => {
  return (dispatch) => {
    ...
    axios
      .post("34.220.146.97:3000/api/cart/list", { products: data }, { headers })
      .then((res) => {
        console.log(res);
      })
      .catch((err) => {
...
export const axiosGetShoppingCartList = (token) => {
  return (dispatch) => {
    ...
    axios
      .get("34.220.146.97:3000/api/cart")
      .then((res) => {
...
export const saveOrderDetailAll = (data) => {
  return (dispatch) => {
    ...
    axios
      .post(
        "34.220.146.97:3000/api/order/products",
        { order_details: data },
        { headers }
      )
      .then((res) => {
...
//         }
//         axios
//           .get('34.220.146.97:3000/api/order/detail', {headers})
//           .then((res) => {
